...
<div class="container">  
        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-md-2" align="right">
                    <button type="button" id="addIncome" class="btn btn-info" title="Add Income">
    ...
    <div id="incomeModal" class="modal fade">
        <div class="modal-dialog">
            <form method="post" id="incomeForm" action="income-action.php">
                <div class="modal-content">
                    ...
                    <div class="modal-body">						
                        <div class="form-group">
                            <label for="income_cat" class="control-label">Category</label>							
